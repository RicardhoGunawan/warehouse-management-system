...
<div class="container mt-4">
    ...
    <form action="/?controller=barang&action=edit&id=<?= $data['barang']['id']; ?>" method="POST">
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="nama" name="nama" value="<?= htmlspecialchars($data['barang']['nama']); ?>" required>
        </div>
        <div class="mb-3">
            <label for="stok" class="form-label">Stok</label>
            <input type="number" class="form-control" id="stok" name="stok" value="<?= htmlspecialchars($data['barang']['stok']); ?>" min="0" required>
        </div>
        <div class="mb-3">
            <label for="expire_date" class="form-label">Tanggal Kedaluwarsa</label>
            <input type="date" class="form-control" id="expire_date" name="expire_date" value="<?= htmlspecialchars($data['barang']['expire_date']); ?>" required>
        </div>
        <div class="mb-3">
            ...
            <select class="form-select" id="supplier_id" name="supplier_id" required>
                ...
                <?php foreach ($suppliers as $supplier): ?>
                    <option value="<?= htmlspecialchars($supplier['id']); ?>" <?= ($supplier['id'] == $data['barang']['supplier_id']) ? 'selected' : ''; ?>>
